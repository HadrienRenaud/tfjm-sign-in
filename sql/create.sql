...
-- Table `mydb`.`tournoi`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tournoi` (
...
-- -----------------------------------------------------
-- Table `mydb`.`encadrants`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`encadrants` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  `firstname` VARCHAR(255) NOT NULL,
  `email` VARCHAR(255) NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`organisateurs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`organisateurs` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`tournoi_has_organisateurs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tournoi_has_organisateurs` (
  `id_tournoi` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_tournoi_has_organisateurs_organisateurs1`
    ...
    REFERENCES `mydb`.`organisateurs` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`teams_has_encadrants`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`teams_has_encadrants` (
